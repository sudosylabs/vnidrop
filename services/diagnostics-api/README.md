...
|---|---|
| Android and legacy Compose desktop | Gradle properties or environment variables; see below. Unconfigured builds use the offline no-op transport. |
...
### Android and legacy Compose desktop
