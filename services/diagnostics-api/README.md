...
| Native Windows | The current Settings form opens the Windows share sheet with report text; it does not submit to this API. |

The Apple and Linux environment variables are `VNIDROP_DIAGNOSTICS_ENDPOINT`
