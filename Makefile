...
apple-project-prebuilt: localization apple-version-config apple-app-config ## Generate the Xcode project reusing an already-installed core (skips apple-core).
	cd $(ROOT)/apple && $(XCODEGEN) generate
