...
public sealed partial class TransferDetailsPage : Page
{
    ...
    private readonly TransferDetailsPageActions actions;
    public TransferDetailsPage(TransferItem item)
    {
        Item = item; actions = new(item); InitializeComponent();
    ...
    private async void Update()
    {
        ...
        StopLabel.Text = Strings.Get(send ? "send_stop_sharing" : "button_cancel_receive");
    }
    ...
    private void Back(object sender, RoutedEventArgs e) => App.Window.ShowTransfers(Item.Transfer.direction == "receive");
